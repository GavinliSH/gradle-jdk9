...
RUN wget —-no–cookies —-no–check–certificate —-header “Cookie: oraclelicense=accept-securebackup-cookie” http://download.oracle.com/otn–pub/java/jdk/9+181/jdk–9_linux–x64_bin.tar.gz –O /opt/jdk/jdk–9_linux–x64_bin.tar.gz
